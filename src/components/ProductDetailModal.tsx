...
import { X, ExternalLink, Heart, Bookmark, MessageCircle, ShieldCheck, Check } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
              ...
              <div className="flex flex-col justify-between h-full">
                <div>
                  ...
                  <h2 className="text-xl sm:text-2xl font-black text-slate-900 font-['Outfit',sans-serif] leading-snug">
                    {product.title}
                  </h2>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className={`flex-1 py-2.5 px-3 rounded-xl border flex items-center justify-center gap-1.5 text-xs font-bold transition-all ${
                        isLiked
                    ...
                    >
                      ...
                      <span>{product.likesCount + (isLiked ? 1 : 0)} Likes</span>
                    </button>
                    ...
                    <button
                      ...
                      className="py-2.5 px-4 rounded-xl border border-slate-200 text-slate-700 hover:bg-slate-50 flex items-center gap-1.5 text-xs font-bold transition-all"
